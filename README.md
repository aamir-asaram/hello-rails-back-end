...
```
$ git clone https://github.com/aamir-asaram/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/aamir-asaram/hello-rails-back-end/issues).
